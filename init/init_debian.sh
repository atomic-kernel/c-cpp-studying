...
# 常用操作
apt --no-install-recommends -y install git git-lfs openssh-client wget curl ca-certificates vim tar gzip xz-utils bzip2 lzma cpio apt-file dpkg-dev iputils-ping bind9-dnsutils make gnome-text-editor diffutils patch gdb gdb-multiarch
apt-file update
